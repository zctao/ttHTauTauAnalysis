...
class ttHtautauAnalyzer : public edm::EDAnalyzer
{
  ...
  private:
    ...
    template <typename T>
    std::vector<T> getSelectedLeptons(const std::vector<T> &,
                                      const std::string &);
    template <typename T>
    void addIDFlags(std::vector<T> &, edm::Handle<reco::GenParticleCollection>);
    ...
    std::vector<pat::Tau> getCorrectedTaus(const std::vector<pat::Tau> &,
    ...
    getMatchedGenParticle(const pat::Muon &,
                          const std::vector<reco::GenParticle> &);
    const reco::GenParticle *
    getMatchedGenParticle(const pat::Electron &,
                          const std::vector<reco::GenParticle> &);
    const reco::GenParticle *
    getMatchedGenParticle(const pat::Tau &,
                          const std::vector<reco::GenParticle> &);
    template <typename T>
    int getMCMatchType(const T &, const std::vector<reco::GenParticle> &);
    ...
    bool pass_event_sel_2lss1tau(const std::vector<miniLepton> &,
                                 ...
                                 const std::vector<miniLepton> &,
                                 const std::vector<pat::Tau> &, const int,
    ...
    void write_ntuple_triggerSF(const miniLepton &,
                                const std::vector<pat::Tau> &, bool, bool);
    void write_ntuple_triggerSF(const miniLepton &,
                                const std::vector<miniTau> &, bool, bool);
...
template <typename T1, typename T2>
std::vector<T1> ttHtautauAnalyzer::removeOverlapdR(const std::vector<T1> &v1,
                                                   const std::vector<T2> &v2,
                                                   double dR)
{
    std::vector<T1> res;
