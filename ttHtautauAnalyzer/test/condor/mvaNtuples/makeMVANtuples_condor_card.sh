...
cd $workdir
produceMVANtuplesv2.py $samples --datasetlist $cmssw/src/ttHTauTauAnalysis/ttHtautauAnalyzer/dataFiles/DatasetList_2017reMiniAODv2.csv --version $ntupleversion -o $outputversion --log $logname --transfer_inputs -c NA --jobtypes datacard
