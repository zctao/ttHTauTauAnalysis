...
makeHistograms.py signal_2lss1tau mvaOutput 0 1 --channels ttH TTW TTWW TTZ EWK Rares tH VH conversions ggH fakes_data flips_data data_obs --luminosity 41.5 -d ../dataFiles/DatasetList_2017reMiniAODv2.csv -vvv --hDecaySplit --genTauSplit --version $mvaNtupleVersion -o datacards_2lss1tau_41p53invfb_noRebin_$date.root --closureFile ../dataFiles/datacard/Closure_FR_syst/Closure_FR_lepton_syst_2lss1tau_41p5invfb.root --systematics | tee yields_2lss1tau_$date.txt
# rebin
...
makeHistograms.py signal_3l1tau mvaOutput 0 1 --channels ttH TTW TTWW TTZ EWK Rares tH VH conversions ggH fakes_data data_obs --luminosity 41.5 -d ../dataFiles/DatasetList_2017reMiniAODv2.csv -vvv --hDecaySplit --genTauSplit --version $mvaNtupleVersion -o datacards_3l1tau_41p53invfb_noRebin_$date.root --closureFile ../dataFiles/datacard/Closure_FR_syst/Closure_FR_lepton_syst_3l1tau_41p5invfb.root --systematics | tee yields_3l1tau_$date.txt
# rebin
