...
date=${1:-2018jun02}
mvaNtupleVersion=${2:-may2018v2_2}
...
# rebin
binDatacards.py 1l2tau datacards_1l2tau_41p53invfb_noRebin_$date.root -o datacards_1l2tau_41p53invfb_Binned_$date.root -c ttH TTW TTZ EWK Rares tH VH Conversion ggH fakes_data data_obs -p
...
# rebin
binDatacards.py 2lss1tau datacards_2lss1tau_41p53invfb_noRebin_$date.root -o datacards_2lss1tau_41p53invfb_Binned_$date.root -c ttH TTW TTZ EWK Rares tH VH Conversion ggH fakes_data flips_data data_obs -p
...
# rebin
binDatacards.py 3l1tau datacards_3l1tau_41p53invfb_noRebin_$date.root -o datacards_3l1tau_41p53invfb_Binned_$date.root -c ttH TTW TTZ EWK Rares tH VH Conversion ggH fakes_data data_obs -p
...
# rebin
binDatacards.py 2l2tau datacards_2l2tau_41p53invfb_noRebin_$date.root -o datacards_2l2tau_41p53invfb_Binned_$date.root -c ttH TTW TTZ EWK Rares tH VH Conversion ggH fakes_data data_obs -p

mkdir -p $outdir
echo "Moving outputs to "$outdir
mv datacards_*.root $outdir
mv datacards_*.txt $outdir
