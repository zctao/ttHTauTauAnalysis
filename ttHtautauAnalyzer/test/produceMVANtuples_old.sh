...
root -b <<EOF
.x ../macro/makeMVANtuple.cc+("$ttHntuple_1l2tau","ttH","1l2tau","$outdir",1,1,0)
.x ../macro/makeMVANtuple.cc+("$ttHntuple_2lss1tau","ttH","2lss1tau","$outdir",1,1,0)
.q
EOF
...
root -b <<EOF
.x ../macro/makeMVANtuple.cc+("$TTdlntuple_1l2tau","TT_DiLep","1l2tau","$outdir",1,0,0)
.x ../macro/makeMVANtuple.cc+("$TTdlntuple_2lss1tau","TT_DiLep","2lss1tau","$outdir",1,0,0)
.x ../macro/makeMVANtuple.cc+("$TTslntuple_1l2tau","TT_SemiLep","1l2tau","$outdir",1,0,0)
.x ../macro/makeMVANtuple.cc+("$TTslntuple_2lss1tau","TT_SemiLep","2lss1tau","$outdir",1,0,0)
.q
EOF
...
root -b <<EOF
.x ../macro/makeMVANtuple.cc+("$ttwntuple_1l2tau","TTW","1l2tau","$outdir",1,1,0)
.x ../macro/makeMVANtuple.cc+("$ttwntuple_2lss1tau","TTW","2lss1tau","$outdir",1,1,0)
.q
EOF
...
root -b <<EOF
.x ../macro/makeMVANtuple.cc+("$ttzntuple_1l2tau","TTZ","1l2tau","$outdir",1,1,0)
.x ../macro/makeMVANtuple.cc+("$ttzntuple_2lss1tau","TTZ","2lss1tau","$outdir",1,1,0)
.q
EOF
