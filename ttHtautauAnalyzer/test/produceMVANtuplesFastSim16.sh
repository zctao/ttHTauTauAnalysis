...
makeMVANtuple -i $ttHntuple_1l2tau -o $outdir'mvaVars_ttH_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --version $version --xsection 0.215 --systematics false -u true -w false --tauWP M --mc_matching $genmatch #--loose_selection true
...
makeMVANtuple -i $TTdlntuple_1l2tau -o $outdir'mvaVars_TT_DiLep_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --version $version --xsection 87.3 --systematics false --mc_matching false -u true -w false --tauWP M #--loose_selection true 
...
makeMVANtuple -i $TTslntuple_1l2tau -o $outdir'mvaVars_TT_SemiLep_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --version $version --xsection 182. --systematics false --mc_matching false -u true -w false --tauWP M #--loose_selection true 
...
makeMVANtuple -i $ttwntuple_1l2tau -o $outdir'mvaVars_TTW_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --version $version --xsection 0.204 --systematics false -u true -w false --tauWP M --mc_matching $genmatch #--loose_selection true
...
makeMVANtuple -i $ttzntuple_1l2tau -o $outdir'mvaVars_TTZ_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --version $version --xsection 0.253 --systematics false -u true -w false --tauWP M --mc_matching $genmatch #--loose_selection true
