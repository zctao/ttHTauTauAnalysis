...
outdir='/uscms/home/ztao/nobackup/mvaNtuples/Dec17/'
...
makeMVANtuple -i $ttHntuple_1l2tau -o $outdir'mvaVars_ttH_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --systematics false --loose_selection true
...
makeMVANtuple -i $TTdlntuple_1l2tau -o $outdir'mvaVars_TT_DiLep_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --systematics false --loose_selection true --mc_matching false
...
makeMVANtuple -i $TTslntuple_1l2tau -o $outdir'mvaVars_TT_SemiLep_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --systematics false --loose_selection true --mc_matching false
...
makeMVANtuple -i $ttwntuple_1l2tau -o $outdir'mvaVars_TTW_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --systematics false --loose_selection true
...
makeMVANtuple -i $ttzntuple_1l2tau -o $outdir'mvaVars_TTZ_1l2tau.root' --anatype 1l2tau --seltype loose_1l2tau --systematics false --loose_selection true
