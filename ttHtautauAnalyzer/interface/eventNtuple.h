...
class eventNtuple
{
  public:
    ...
    std::vector<TLorentzVector> buildFourVectorTaus(std::vector<int> &,
    ...
    buildFourVectorTauDaugsCharged(bool loose = false) const;
    std::vector<TLorentzVector>
    buildFourVectorTauDaugsNeutral(bool loose = false) const;
