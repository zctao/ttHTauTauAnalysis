...
parser.add_argument('--lumimask', type=str,
                    default='https://cms-service-dqm.web.cern.ch/cms-service-dqm/CAF/certification/Collisions17/13TeV/Final/Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt', help='Lumi mask to run on data sample')
