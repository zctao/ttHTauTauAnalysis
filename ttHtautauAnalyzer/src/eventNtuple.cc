...
void eventNtuple::initialize()
{
	...
	tau_ecalStripSumEOverPLead->clear();
	tau_emFraction->clear();
	tau0_signalChargedHadrCands_pt->clear();
	tau0_signalChargedHadrCands_eta->clear();
	tau0_signalChargedHadrCands_phi->clear();
	tau0_signalChargedHadrCands_E->clear();
	tau0_signalNeutrHadrCands_pt->clear();
	tau0_signalNeutrHadrCands_eta->clear();
	tau0_signalNeutrHadrCands_phi->clear();
	tau0_signalNeutrHadrCands_E->clear();
	tau0_signalGammaCands_pt->clear();
	tau0_signalGammaCands_eta->clear();
	tau0_signalGammaCands_phi->clear();
	tau0_signalGammaCands_E->clear();
	tau0_signalTracks_pt->clear();
	tau0_signalTracks_eta->clear();
	tau0_signalTracks_phi->clear();
	tau0_signalTracks_E->clear();
	tau1_signalChargedHadrCands_pt->clear();
	tau1_signalChargedHadrCands_eta->clear();
	tau1_signalChargedHadrCands_phi->clear();
	tau1_signalChargedHadrCands_E->clear();
	tau1_signalNeutrHadrCands_pt->clear();
	tau1_signalNeutrHadrCands_eta->clear();
	tau1_signalNeutrHadrCands_phi->clear();
	tau1_signalNeutrHadrCands_E->clear();
	tau1_signalGammaCands_pt->clear();
	tau1_signalGammaCands_eta->clear();
	tau1_signalGammaCands_phi->clear();
	tau1_signalGammaCands_E->clear();
	tau1_signalTracks_pt->clear();
	tau1_signalTracks_eta->clear();
	tau1_signalTracks_phi->clear();
	tau1_signalTracks_E->clear();
...
void eventNtuple::setup_branches(TTree* tree)
{
	...
	tree->Branch("tau_ecalStripSumEOverPLead", &tau_ecalStripSumEOverPLead);
	tree->Branch("tau_emFraction", &tau_emFraction);
	tree->Branch("tau0_signalChargedHadrCands_pt", &tau0_signalChargedHadrCands_pt);
	tree->Branch("tau0_signalChargedHadrCands_eta", &tau0_signalChargedHadrCands_eta);
	tree->Branch("tau0_signalChargedHadrCands_phi", &tau0_signalChargedHadrCands_phi);
	tree->Branch("tau0_signalChargedHadrCands_E", &tau0_signalChargedHadrCands_E);
	tree->Branch("tau0_signalNeutrHadrCands_pt", &tau0_signalNeutrHadrCands_pt);
	tree->Branch("tau0_signalNeutrHadrCands_eta", &tau0_signalNeutrHadrCands_eta);
	tree->Branch("tau0_signalNeutrHadrCands_phi", &tau0_signalNeutrHadrCands_phi);
	tree->Branch("tau0_signalNeutrHadrCands_E", &tau0_signalNeutrHadrCands_E);
	tree->Branch("tau0_signalGammaCands_pt", &tau0_signalGammaCands_pt);
	tree->Branch("tau0_signalGammaCands_eta", &tau0_signalGammaCands_eta);
	tree->Branch("tau0_signalGammaCands_phi", &tau0_signalGammaCands_phi);
	tree->Branch("tau0_signalGammaCands_E", &tau0_signalGammaCands_E);
	tree->Branch("tau0_signalTracks_pt", &tau0_signalTracks_pt);
	tree->Branch("tau0_signalTracks_eta", &tau0_signalTracks_eta);
	tree->Branch("tau0_signalTracks_phi", &tau0_signalTracks_phi);
	tree->Branch("tau0_signalTracks_E", &tau0_signalTracks_E);
	tree->Branch("tau1_signalChargedHadrCands_pt", &tau1_signalChargedHadrCands_pt);
	tree->Branch("tau1_signalChargedHadrCands_eta", &tau1_signalChargedHadrCands_eta);
	tree->Branch("tau1_signalChargedHadrCands_phi", &tau1_signalChargedHadrCands_phi);
	tree->Branch("tau1_signalChargedHadrCands_E", &tau1_signalChargedHadrCands_E);
	tree->Branch("tau1_signalNeutrHadrCands_pt", &tau1_signalNeutrHadrCands_pt);
	tree->Branch("tau1_signalNeutrHadrCands_eta", &tau1_signalNeutrHadrCands_eta);
	tree->Branch("tau1_signalNeutrHadrCands_phi", &tau1_signalNeutrHadrCands_phi);
	tree->Branch("tau1_signalNeutrHadrCands_E", &tau1_signalNeutrHadrCands_E);
	tree->Branch("tau1_signalGammaCands_pt", &tau1_signalGammaCands_pt);
	tree->Branch("tau1_signalGammaCands_eta", &tau1_signalGammaCands_eta);
	tree->Branch("tau1_signalGammaCands_phi", &tau1_signalGammaCands_phi);
	tree->Branch("tau1_signalGammaCands_E", &tau1_signalGammaCands_E);
	tree->Branch("tau1_signalTracks_pt", &tau1_signalTracks_pt);
	tree->Branch("tau1_signalTracks_eta", &tau1_signalTracks_eta);
	tree->Branch("tau1_signalTracks_phi", &tau1_signalTracks_phi);
	tree->Branch("tau1_signalTracks_E", &tau1_signalTracks_E);
...
void eventNtuple::set_branch_address(TTree* tree)
{
	...
	tree->SetBranchAddress("tau0_signalChargedHadrCands_pt", &tau0_signalChargedHadrCands_pt);
	tree->SetBranchAddress("tau0_signalChargedHadrCands_eta", &tau0_signalChargedHadrCands_eta);
	tree->SetBranchAddress("tau0_signalChargedHadrCands_phi", &tau0_signalChargedHadrCands_phi);
	tree->SetBranchAddress("tau0_signalChargedHadrCands_E", &tau0_signalChargedHadrCands_E);
	tree->SetBranchAddress("tau0_signalNeutrHadrCands_pt", &tau0_signalNeutrHadrCands_pt);
	tree->SetBranchAddress("tau0_signalNeutrHadrCands_eta", &tau0_signalNeutrHadrCands_eta);
	tree->SetBranchAddress("tau0_signalNeutrHadrCands_phi", &tau0_signalNeutrHadrCands_phi);
	tree->SetBranchAddress("tau0_signalNeutrHadrCands_E", &tau0_signalNeutrHadrCands_E);
	tree->SetBranchAddress("tau0_signalGammaCands_pt", &tau0_signalGammaCands_pt);
	tree->SetBranchAddress("tau0_signalGammaCands_eta", &tau0_signalGammaCands_eta);
	tree->SetBranchAddress("tau0_signalGammaCands_phi", &tau0_signalGammaCands_phi);
	tree->SetBranchAddress("tau0_signalGammaCands_E", &tau0_signalGammaCands_E);
	tree->SetBranchAddress("tau0_signalTracks_pt", &tau0_signalTracks_pt);
	tree->SetBranchAddress("tau0_signalTracks_eta", &tau0_signalTracks_eta);
	tree->SetBranchAddress("tau0_signalTracks_phi", &tau0_signalTracks_phi);
	tree->SetBranchAddress("tau0_signalTracks_E", &tau0_signalTracks_E);
	tree->SetBranchAddress("tau1_signalChargedHadrCands_pt", &tau1_signalChargedHadrCands_pt);
	tree->SetBranchAddress("tau1_signalChargedHadrCands_eta", &tau1_signalChargedHadrCands_eta);
	tree->SetBranchAddress("tau1_signalChargedHadrCands_phi", &tau1_signalChargedHadrCands_phi);
	tree->SetBranchAddress("tau1_signalChargedHadrCands_E", &tau1_signalChargedHadrCands_E);
	tree->SetBranchAddress("tau1_signalNeutrHadrCands_pt", &tau1_signalNeutrHadrCands_pt);
	tree->SetBranchAddress("tau1_signalNeutrHadrCands_eta", &tau1_signalNeutrHadrCands_eta);
	tree->SetBranchAddress("tau1_signalNeutrHadrCands_phi", &tau1_signalNeutrHadrCands_phi);
	tree->SetBranchAddress("tau1_signalNeutrHadrCands_E", &tau1_signalNeutrHadrCands_E);
	tree->SetBranchAddress("tau1_signalGammaCands_pt", &tau1_signalGammaCands_pt);
	tree->SetBranchAddress("tau1_signalGammaCands_eta", &tau1_signalGammaCands_eta);
	tree->SetBranchAddress("tau1_signalGammaCands_phi", &tau1_signalGammaCands_phi);
	tree->SetBranchAddress("tau1_signalGammaCands_E", &tau1_signalGammaCands_E);
	tree->SetBranchAddress("tau1_signalTracks_pt", &tau1_signalTracks_pt);
	tree->SetBranchAddress("tau1_signalTracks_eta", &tau1_signalTracks_eta);
	tree->SetBranchAddress("tau1_signalTracks_phi", &tau1_signalTracks_phi);
	tree->SetBranchAddress("tau1_signalTracks_E", &tau1_signalTracks_E);
