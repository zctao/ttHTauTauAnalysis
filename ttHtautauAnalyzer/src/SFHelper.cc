                   ...
                   bool isdata, bool debug)
{
    ...
    TString tauIDWP =
        (analysis == Analyze_1l2tau) ? "dR03mvaTight" : "dR03mvaMedium";
    ...
    if (_selection == Control_fake_2lss1tau or
        _selection == Control_fake_1l2tau or
        _selection == Control_fake_3l1tau) {
...
{
    const std::string base = std::string(getenv("CMSSW_BASE")) +
                             "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/";
...
{
    file_fr_tau = new TFile(
        (std::string(getenv("CMSSW_BASE")) +
         "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/FR_tau_2016.root")
            .c_str(),
        "read");

    f_fakerate_tau_mvaM_etaL_ratio = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEtaLt1_5/fitFunction_data_div_mc_hadTaus_pt");
    f_fakerate_tau_mvaM_etaH_ratio = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEta1_5to9_9/fitFunction_data_div_mc_hadTaus_pt");

    // systematics
    f_fakerate_tau_mvaM_etaL_ratio_normUp = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEtaLt1_5/fitFunction_data_div_mc_hadTaus_pt_par1Up");
    f_fakerate_tau_mvaM_etaL_ratio_normDown = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEtaLt1_5/fitFunction_data_div_mc_hadTaus_pt_par1Down");
    f_fakerate_tau_mvaM_etaL_ratio_shapeUp = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEtaLt1_5/fitFunction_data_div_mc_hadTaus_pt_par2Up");
    f_fakerate_tau_mvaM_etaL_ratio_shapeDown = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEtaLt1_5/fitFunction_data_div_mc_hadTaus_pt_par2Down");
    f_fakerate_tau_mvaM_etaH_ratio_normUp = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEta1_5to9_9/fitFunction_data_div_mc_hadTaus_pt_par1Up");
    f_fakerate_tau_mvaM_etaH_ratio_normDown = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEta1_5to9_9/fitFunction_data_div_mc_hadTaus_pt_par1Down");
    f_fakerate_tau_mvaM_etaH_ratio_shapeUp = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEta1_5to9_9/fitFunction_data_div_mc_hadTaus_pt_par2Up");
    f_fakerate_tau_mvaM_etaH_ratio_shapeDown = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEta1_5to9_9/fitFunction_data_div_mc_hadTaus_pt_par2Down");
}

void SFHelper::Set_up_PUWeight_hist()
{
    // file_puweight = new TFile((std::string(getenv("CMSSW_BASE")) +
    // "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/PU_weights/PU_weights_2016_271036_284044.root").c_str(),
    // "read");
    file_puweight =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/PU_weights/"
                   "PU_weights_MCSummer2016_271036_284044.root")
                      .c_str(),
                  "read");
...
{
    // electrons and muons
    file_fr_lep = new TFile(
        (std::string(getenv("CMSSW_BASE")) +
         "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/FR_data_ttH_mva.root")
            .c_str(),
        "read");
    ...
    // systematics
    h_fakerate_el_normUp =
        (TH2F *)file_fr_lep->Get("FR_mva075_el_data_comb_up");
    h_fakerate_el_normDown =
        (TH2F *)file_fr_lep->Get("FR_mva075_el_data_comb_down");
    h_fakerate_el_ptUp = (TH2F *)file_fr_lep->Get("FR_mva075_el_data_comb_pt1");
    h_fakerate_el_ptDown =
        (TH2F *)file_fr_lep->Get("FR_mva075_el_data_comb_pt2");
    ...
    h_fakerate_el_ecDown =
        (TH2F *)file_fr_lep->Get("FR_mva075_el_data_comb_ec2");
    h_fakerate_mu_normUp =
        (TH2F *)file_fr_lep->Get("FR_mva075_mu_data_comb_up");
    h_fakerate_mu_normDown =
        (TH2F *)file_fr_lep->Get("FR_mva075_mu_data_comb_down");
    h_fakerate_mu_ptUp = (TH2F *)file_fr_lep->Get("FR_mva075_mu_data_comb_pt1");
    h_fakerate_mu_ptDown =
        (TH2F *)file_fr_lep->Get("FR_mva075_mu_data_comb_pt2");
    ...
    h_fakerate_mu_ecDown =
        (TH2F *)file_fr_lep->Get("FR_mva075_mu_data_comb_ec2");
    ...
    g_fakerate_tau_mvaM_etaL_mc = (TGraphAsymmErrors *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEtaLt1_5/jetToTauFakeRate_mc_hadTaus_pt");
    g_fakerate_tau_mvaM_etaH_mc = (TGraphAsymmErrors *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEta1_5to9_9/jetToTauFakeRate_mc_hadTaus_pt");
    f_fakerate_tau_mvaM_etaL_ratio = (TF1 *)file_fr_tau->Get(
        "jetToTauFakeRate/" + tauIDWP +
        "/absEtaLt1_5/fitFunction_data_div_mc_hadTaus_pt");
    f_fakerate_tau_mvaM_etaH_ratio = (TF1 *)file_fr_tau->Get(
...
{
    file_eleMisCharge = new TFile(
        (std::string(getenv("CMSSW_BASE")) +
         "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/QF_data_el.root")
            .c_str(),
        "read");
...
void SFHelper::Set_up_LeptonSF_Lut()
{
    ...
    /// for muons
    // loose vs reco
    file_recoToLoose_leptonSF_mu1 =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                   "TnP_NUM_LooseID_DENOM_generalTracks_VAR_map_pt_eta.root")
                      .c_str(),
                  "read");
    file_recoToLoose_leptonSF_mu2 =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                   "TnP_NUM_MiniIsoLoose_DENOM_LooseID_VAR_map_pt_eta.root")
                      .c_str(),
                  "read");
    file_recoToLoose_leptonSF_mu3 =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                   "TnP_NUM_TightIP2D_DENOM_MediumID_VAR_map_pt_eta.root")
                      .c_str(),
                  "read");
    file_recoToLoose_leptonSF_mu4 =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                   "ratios_HIP_trkEff.root")
                      .c_str(),
                  "read");

    h_recoToLoose_leptonSF_mu1 =
        (TH2F *)(file_recoToLoose_leptonSF_mu1->Get("SF"));
    h_recoToLoose_leptonSF_mu2 =
        (TH2F *)(file_recoToLoose_leptonSF_mu2->Get("SF"));
    h_recoToLoose_leptonSF_mu3 =
        (TH2F *)(file_recoToLoose_leptonSF_mu3->Get("SF"));
    h_recoToLoose_leptonSF_mu4 =
        (TGraphAsymmErrors *)(file_recoToLoose_leptonSF_mu4->Get("ratio_eta"));

    /// for electrons
    // loose vs reco
    file_recoToLoose_leptonSF_el =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                   "el_scaleFactors_Moriond17.root")
                      .c_str(),
                  "read");
    file_recoToLoose_leptonSF_gsf =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
    ...
    h_recoToLoose_leptonSF_el1 = (TH2F *)(file_recoToLoose_leptonSF_el->Get(
        "GsfElectronToMVAVLooseFOIDEmuTightIP2D"));
    h_recoToLoose_leptonSF_el2 =
        (TH2F *)(file_recoToLoose_leptonSF_el->Get("MVAVLooseElectronToMini4"));
    h_recoToLoose_leptonSF_el3 = (TH2F *)(file_recoToLoose_leptonSF_el->Get(
        "MVAVLooseElectronToConvVetoIHit1"));
    h_recoToLoose_leptonSF_gsf =
        (TH2F *)(file_recoToLoose_leptonSF_gsf->Get("EGamma_SF2D"));

    //// tight vs loose
    if (_analysis == Analyze_2lss1tau) {
        /// for muon
        file_looseToTight_leptonSF_mu_2lss =
            new TFile((std::string(getenv("CMSSW_BASE")) +
                       "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                       "lepMVAEffSF_m_2lss.root")
                          .c_str(),
                      "read");
        h_looseToTight_leptonSF_mu_2lss =
            (TH2F *)(file_looseToTight_leptonSF_mu_2lss->Get("sf"));

        /// for electron
        file_looseToTight_leptonSF_el_2lss =
            new TFile((std::string(getenv("CMSSW_BASE")) +
                       "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                       "lepMVAEffSF_e_2lss.root")
                          .c_str(),
                      "read");
        h_looseToTight_leptonSF_el_2lss =
            (TH2F *)(file_looseToTight_leptonSF_el_2lss->Get("sf"));
    }

    if (_analysis == Analyze_3l1tau) {
        /// for muon
        file_looseToTight_leptonSF_mu_3l =
            new TFile((std::string(getenv("CMSSW_BASE")) +
                       "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                       "lepMVAEffSF_m_3l.root")
                          .c_str(),
                      "read");
        h_looseToTight_leptonSF_mu_3l =
            (TH2F *)(file_looseToTight_leptonSF_mu_3l->Get("sf"));

        /// for electron
        file_looseToTight_leptonSF_el_3l =
            new TFile((std::string(getenv("CMSSW_BASE")) +
                       "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/leptonSF/"
                       "lepMVAEffSF_e_3l.root")
                          .c_str(),
                      "read");
        h_looseToTight_leptonSF_el_3l =
            (TH2F *)(file_looseToTight_leptonSF_el_3l->Get("sf"));
    }
}
...
void SFHelper::Set_up_triggerSF_Lut()
{
    ...
    file_Mu22OR_eff = new TFile((std::string(getenv("CMSSW_BASE")) +
                                 "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/"
                                 "data/triggerSF/Muon_Mu22OR_eta2p1_eff.root")
                                    .c_str(),
                                "read");
    assert(file_Mu22OR_eff->IsOpen());
    g_Mu_ZMassEtaLt0p9_MC =
        (TGraphAsymmErrors *)file_Mu22OR_eff->Get("ZMassEtaLt0p9_MC");
    g_Mu_ZMassEta0p9to1p2_MC =
        (TGraphAsymmErrors *)file_Mu22OR_eff->Get("ZMassEta0p9to1p2_MC");
    g_Mu_ZMassEta1p2to2p1_MC =
        (TGraphAsymmErrors *)file_Mu22OR_eff->Get("ZMassEta1p2to2p1_MC");
    g_Mu_ZMassEtaLt0p9_Data =
        (TGraphAsymmErrors *)file_Mu22OR_eff->Get("ZMassEtaLt0p9_Data");
    g_Mu_ZMassEta0p9to1p2_Data =
        (TGraphAsymmErrors *)file_Mu22OR_eff->Get("ZMassEta0p9to1p2_Data");
    g_Mu_ZMassEta1p2to2p1_Data =
        (TGraphAsymmErrors *)file_Mu22OR_eff->Get("ZMassEta1p2to2p1_Data");

    // Single Electron triggers
    file_Ele25WPTight_eff =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/triggerSF/"
                   "Electron_Ele25WPTight_eff.root")
                      .c_str(),
                  "read");
    assert(file_Ele25WPTight_eff->IsOpen());
    g_Ele_ZMassEtaLt1p48_MC =
        (TGraphAsymmErrors *)file_Ele25WPTight_eff->Get("ZMassEtaLt1p48_MC");
    g_Ele_ZMassEta1p48to2p1_MC =
        (TGraphAsymmErrors *)file_Ele25WPTight_eff->Get("ZMassEta1p48to2p1_MC");
    g_Ele_ZMassEtaGt2p1_MC =
        (TGraphAsymmErrors *)file_Ele25WPTight_eff->Get("ZMassEtaGt2p1_MC");
    g_Ele_ZMassEtaLt1p48_Data =
        (TGraphAsymmErrors *)file_Ele25WPTight_eff->Get("ZMassEtaLt1p48_Data");
    g_Ele_ZMassEta1p48to2p1_Data =
        (TGraphAsymmErrors *)file_Ele25WPTight_eff->Get(
            "ZMassEta1p48to2p1_Data");
    g_Ele_ZMassEtaGt2p1_Data =
        (TGraphAsymmErrors *)file_Ele25WPTight_eff->Get("ZMassEtaGt2p1_Data");

    // Muon leg of mu tau cross trigger
    file_Mu19leg_eff =
        new TFile((std::string(getenv("CMSSW_BASE")) +
                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/data/triggerSF/"
                   "Muon_Mu19leg_2016BtoH_eff.root")
                      .c_str(),
                  "read");
    assert(file_Mu19leg_eff->IsOpen());
    g_Muleg_ZMassEtaLt0p9_MC =
        (TGraphAsymmErrors *)file_Mu19leg_eff->Get("ZMassEtaLt0p9_MC");
    g_Muleg_ZMassEta0p9to1p2_MC =
        (TGraphAsymmErrors *)file_Mu19leg_eff->Get("ZMassEta0p9to1p2_MC");
    g_Muleg_ZMassEta1p2to2p1_MC =
        (TGraphAsymmErrors *)file_Mu19leg_eff->Get("ZMassEta1p2to2p1_MC");
    g_Muleg_ZMassEtaLt0p9_Data =
        (TGraphAsymmErrors *)file_Mu19leg_eff->Get("ZMassEtaLt0p9_Data");
    g_Muleg_ZMassEta0p9to1p2_Data =
        (TGraphAsymmErrors *)file_Mu19leg_eff->Get("ZMassEta0p9to1p2_Data");
    g_Muleg_ZMassEta1p2to2p1_Data =
        (TGraphAsymmErrors *)file_Mu19leg_eff->Get("ZMassEta1p2to2p1_Data");

    // Electron leg of e tau cross trigger
    file_Ele24leg_eff = new TFile((std::string(getenv("CMSSW_BASE")) +
                                   "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/"
                                   "data/triggerSF/Electron_Ele24_eff.root")
                                      .c_str(),
                                  "read");
    assert(file_Ele24leg_eff->IsOpen());
    g_Eleleg_ZMassEtaLt1p48_MC =
        (TGraphAsymmErrors *)file_Ele24leg_eff->Get("ZMassEtaLt1p48_MC");
    g_Eleleg_ZMassEta1p48to2p1_MC =
        (TGraphAsymmErrors *)file_Ele24leg_eff->Get("ZMassEta1p48to2p1_MC");
    g_Eleleg_ZMassEtaGt2p1_MC =
        (TGraphAsymmErrors *)file_Ele24leg_eff->Get("ZMassEtaGt2p1_MC");
    g_Eleleg_ZMassEtaLt1p48_Data =
        (TGraphAsymmErrors *)file_Ele24leg_eff->Get("ZMassEtaLt1p48_Data");
    g_Eleleg_ZMassEta1p48to2p1_Data =
        (TGraphAsymmErrors *)file_Ele24leg_eff->Get("ZMassEta1p48to2p1_Data");
    g_Eleleg_ZMassEtaGt2p1_Data =
        (TGraphAsymmErrors *)file_Ele24leg_eff->Get("ZMassEtaGt2p1_Data");

    // Tau leg of mu tau cross trigger
    file_mt_Tauleg_eff = new TFile((std::string(getenv("CMSSW_BASE")) +
                                    "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/"
                                    "data/triggerSF/trigger_sf_mt.root")
                                       .c_str(),
                                   "read");
    assert(file_mt_Tauleg_eff->IsOpen());
    g_mt_mc_genuine_barrel_TightIso =
        (TGraphAsymmErrors *)file_mt_Tauleg_eff->Get(
            "mc_genuine_barrel_TightIso");
    g_mt_mc_genuine_endcap_TightIso =
        (TGraphAsymmErrors *)file_mt_Tauleg_eff->Get(
            "mc_genuine_endcap_TightIso");
    g_mt_data_genuine_barrel_TightIso =
        (TGraphAsymmErrors *)file_mt_Tauleg_eff->Get(
            "data_genuine_barrel_TightIso");
    g_mt_data_genuine_endcap_TightIso =
        (TGraphAsymmErrors *)file_mt_Tauleg_eff->Get(
            "data_genuine_endcap_TightIso");

    // Tau leg of e tau cross trigger
    file_et_Tauleg_eff = new TFile((std::string(getenv("CMSSW_BASE")) +
                                    "/src/ttHTauTauAnalysis/ttHtautauAnalyzer/"
                                    "data/triggerSF/trigger_sf_et.root")
                                       .c_str(),
                                   "read");
    assert(file_et_Tauleg_eff->IsOpen());
    g_et_mc_genuine_barrel_TightIso =
        (TGraphAsymmErrors *)file_et_Tauleg_eff->Get(
            "mc_genuine_barrel_TightIso");
    g_et_mc_genuine_endcap_TightIso =
        (TGraphAsymmErrors *)file_et_Tauleg_eff->Get(
            "mc_genuine_endcap_TightIso");
    g_et_data_genuine_barrel_TightIso_dm0 =
        (TGraphAsymmErrors *)file_et_Tauleg_eff->Get(
            "data_genuine_barrel_TightIso_dm0");
    g_et_data_genuine_barrel_TightIso_dm1 =
        (TGraphAsymmErrors *)file_et_Tauleg_eff->Get(
            "data_genuine_barrel_TightIso_dm1");
    g_et_data_genuine_barrel_TightIso_dm10 =
        (TGraphAsymmErrors *)file_et_Tauleg_eff->Get(
            "data_genuine_barrel_TightIso_dm10");
    g_et_data_genuine_endcap_TightIso_dm0 =
        (TGraphAsymmErrors *)file_et_Tauleg_eff->Get(
            "data_genuine_endcap_TightIso_dm0");
    g_et_data_genuine_endcap_TightIso_dm1 =
        (TGraphAsymmErrors *)file_et_Tauleg_eff->Get(
            "data_genuine_endcap_TightIso_dm1");
    g_et_data_genuine_endcap_TightIso_dm10 =
        (TGraphAsymmErrors *)file_et_Tauleg_eff->Get(
            "data_genuine_endcap_TightIso_dm10");
}
...
#if !defined(__ACLIC__) && !defined(__ROOTCLING__)
void SFHelper::Delete_BTagCalibration_Readers() { delete BTagCaliReader; }
#endif

float SFHelper::Get_HLTSF(const std::vector<miniLepton> &leptons,
                          const std::vector<miniTau> &taus, bool hlt1LTriggered,
                          bool hltXTriggered)
{
    if (_analysis == Analyze_2lss1tau) {
        ...
        if (abs(leptons[0].pdgId()) == 13 and abs(leptons[1].pdgId()) == 13)
            lepcat = 0;
        else if (abs(leptons[0].pdgId()) == 11 and
                 abs(leptons[1].pdgId()) == 11)
            lepcat = 1;
        else
            lepcat = 2;
        ...
        return Get_HLTSF_1l2tau(leptons[0], taus, hlt1LTriggered,
                                hltXTriggered);
                                 ...
                                 bool passHLT1l, bool passHLT1l1tau)
{
    ...
    float eff_t0_data = Get_trig_eff_tauLeg_crossTrigger(
        tau0Pt, tau0Eta, decaymode0, lepPdgId, 1);
    float eff_t0_mc = Get_trig_eff_tauLeg_crossTrigger(tau0Pt, tau0Eta,
                                                       decaymode0, lepPdgId, 0);
    float eff_t1_data = Get_trig_eff_tauLeg_crossTrigger(
        tau1Pt, tau1Eta, decaymode1, lepPdgId, 1);
    float eff_t1_mc = Get_trig_eff_tauLeg_crossTrigger(tau1Pt, tau1Eta,
                                                       decaymode1, lepPdgId, 0);

    // compute trigger efficiency based on triggered HLT paths
    float eff_data =
        Compute_trig_eff_OR_1l2tau(eff_L_data, eff_l_data, eff_t0_data,
                                   eff_t1_data, passHLT1l, passHLT1l1tau);
    float eff_mc = Compute_trig_eff_OR_1l2tau(
        eff_L_mc, eff_l_mc, eff_t0_mc, eff_t1_mc, passHLT1l, passHLT1l1tau);
                                           ...
                                           bool passHLT1l, bool passHLT1l1tau)
{
    if (passHLT1l and !passHLT1l1tau) { // only the single lepton trigger fires
        return std::max(1.e-2f,
                        eff_L -
                            std::min(eff_L, eff_l) *
                                (1 - (1 - eff_tau0) * (1 - eff_tau1)));
    } else if (!passHLT1l and passHLT1l1tau) { // only cross trigger fires
        return std::max(
            1.e-2f, (eff_l - eff_L) * (1 - (1 - eff_tau0) * (1 - eff_tau1)));
        ...
        if (fabs(eta) < 1.479) { // barrel
            if (isdata) {
                if (decaymode == 0)
                    ...
                    eff =
                        evalTGraph(g_et_data_genuine_barrel_TightIso_dm10, pt);
            } else
            ...
            if (isdata) {
                if (decaymode == 0)
                    ...
                    eff =
                        evalTGraph(g_et_data_genuine_endcap_TightIso_dm10, pt);
            } else
...
float SFHelper::Get_trig_eff_singleLep(float pt, float eta, int pdgid,
                                       bool isdata)
{
    assert(_analysis == Analyze_1l2tau);
...
//#endif
float SFHelper::Get_LeptonSF_loose(float lepPt, float lepEta, bool isEle,
                                   bool isMu)
{
    float sf = 1.;
                                            ...
                                            bool isEle, bool isMu)
{
    ...
    if (_analysis == Analyze_2lss1tau) {
        if (isMu) {
            sf = read2DHist(h_looseToTight_leptonSF_mu_2lss, lepPt,
                            std::abs(lepEta));
        } else if (isEle) {
            sf = read2DHist(h_looseToTight_leptonSF_el_2lss, lepPt,
                            std::abs(lepEta));
        }
    } else if (_analysis == Analyze_3l1tau) {
        if (isMu) {
            sf = read2DHist(h_looseToTight_leptonSF_mu_3l, lepPt,
                            std::abs(lepEta));
        } else if (isEle) {
            sf = read2DHist(h_looseToTight_leptonSF_el_3l, lepPt,
                            std::abs(lepEta));
        }
    }
...
float SFHelper::Get_JetCSVWeight(const pat::Jet &jet,
                                 std::string sys /*pass by copy*/)
{
    double pt = jet.pt();
    double eta = jet.eta();
    // double csv =
    ...
    weight_jet =
        BTagCaliReader->eval_auto_bounds(sys, jf, std::abs(eta), pt, csv);
...
float SFHelper::Get_TauIDSF_weight(const std::vector<miniTau> &taus,
                                   TString syst)
{
    size_t ntaus = 1;
    if (_analysis == Analyze_1l2tau)
...
float SFHelper::Get_FR_weight(const std::vector<miniLepton> &leps,
                              const std::vector<pat::Tau> &taus, TString syst)
{
...
float SFHelper::Get_FakeRate_lep(float lepConePt, float lepEta, bool isEle,
                                 bool isMuon, TString syst)
{
    float fakerate = 0;

    if (syst == "FRe_normUp" and isEle) {
        fakerate =
            read2DHist(h_fakerate_el_normUp, lepConePt, std::abs(lepEta));
    } else if (syst == "FRe_normDown" and isEle) {
        fakerate =
            read2DHist(h_fakerate_el_normDown, lepConePt, std::abs(lepEta));
        ...
        fakerate =
            read2DHist(h_fakerate_el_ptDown, lepConePt, std::abs(lepEta));
        ...
        fakerate =
            read2DHist(h_fakerate_el_ecDown, lepConePt, std::abs(lepEta));
    } else if (syst == "FRm_normUp" and isMuon) {
        fakerate =
            read2DHist(h_fakerate_mu_normUp, lepConePt, std::abs(lepEta));
    } else if (syst == "FRm_normDown" and isMuon) {
        fakerate =
            read2DHist(h_fakerate_mu_normDown, lepConePt, std::abs(lepEta));
        ...
        fakerate =
            read2DHist(h_fakerate_mu_ptDown, lepConePt, std::abs(lepEta));
        ...
        fakerate =
            read2DHist(h_fakerate_mu_ecDown, lepConePt, std::abs(lepEta));
    } else if (isEle)
...
float SFHelper::Get_FR_weight(const std::vector<miniLepton> &leps,
                              const std::vector<miniTau> &taus, TString syst)
{
    float F1, F2, F3 = -1.;
    float f1, f2, f3 = 0.;
    float FR_weight = 0.;
    ...
    if (_selection == Control_fake_1l2tau) {
        ...
        FR_weight = F1 * F2 * F3;
        if (_debug)
            std::cout << "FR_weight : " << F1 * F2 * F3 << std::endl;
        ...
        FR_weight = -1. * F1 * F2;
        if (_debug)
            std::cout << "FR_weight : " << -1 * F1 * F2 << std::endl;
                                     ...
                                     int tauCharge)
{
    ...
    float P1_misCharge = Get_EleChargeMisIDProb(leps[0], tauCharge);
    float P2_misCharge = Get_EleChargeMisIDProb(leps[1], tauCharge);
...
float SFHelper::Get_EleChargeMisIDProb(const miniLepton &lepton, int tauCharge)
{
    ...
    return Get_EleChargeMisIDProb(lepton.pt(), lepton.eta(), lepton.charge(),
                                  tauCharge);
}

float SFHelper::Get_EleChargeMisIDProb(float elePt, float eleEta, int eleCharge,
                                       int tauCharge)
{
...
{
    float x1 =
        std::max(float(graph->GetXaxis()->GetXmin() + 1e-5),
...
float SFHelper::readTGraph(TGraphAsymmErrors *graph, float x)
{
    ...
    for (int i = 0; i < nPoints; ++i) {
        ...
        if (ip != -1) {
            if (x > xp - xerr_l and x < xp + xerr_h)
                return yp;
        }
    }
    return yp;
