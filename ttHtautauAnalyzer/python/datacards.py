...
SamplesInChannel2017 = {'ttH':['ttHJetToNonbb'],
                        ...
                        'Rares':['WWW','WWZ','WZZ','ZZZ','tZq','TTTT','WpWpJJ', 'WWTo2L2Nuds','TTGJets'],
                        'tH':['tHq','tHW'],
                        'tHq':['tHq'],
                        'tHW':['tHW'],
                        'conversions':['TTGJets','TTZ','TTW_psw','TTWW','WZTo3LNu','ZZ_ext'],
                        #'Conversion':['TTGJets'],            
                        #'Convs':['TTGJets'],
                        'ggH':['ggHZZ4l'],
                        'VH':['VHToNonbb'],
                        'TT':['TTToDiLep_psw','TTToSemiLep_psw','TTToHad'],
                        'ST':['ST_sLep','ST_tT','ST_tTbar','ST_tWT','ST_tWTbar','ST_tWll'],
