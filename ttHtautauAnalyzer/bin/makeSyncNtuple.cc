...
TTree *makeSyncTree(const TString, const TString,
...
int main(int argc, char **argv)
{
    ...
    desc.add_options()("help,h", "produce help message")(
        ...
        "makeObjectNtuple",
        po::value<bool>(&makeObjectNtuple)->default_value(false))(
    ...
    if (make1l2tau) {
        ...
        synctree_1l2tau_sr = makeSyncTree(
            cdir + "output_sync_event_1l2tau_incl.root", "syncTree_1l2tau_SR",
            Analyze_1l2tau, Signal_1l2tau, debug);

        cout << "1l2tau fake extrapolation region ... " << endl;
        synctree_1l2tau_fake = makeSyncTree(
            cdir + "output_sync_event_1l2tau_incl.root", "syncTree_1l2tau_Fake",
    ...
    if (make2lss1tau) {
        ...
        synctree_2lss1tau_sr = makeSyncTree(
            cdir + "output_sync_event_2lss1tau_incl.root",
            "syncTree_2lSS1tau_SR", Analyze_2lss1tau, Signal_2lss1tau, debug);

        cout << "2lss1tau fake extrapolation region ... " << endl;
        synctree_2lss1tau_fake =
            makeSyncTree(cdir + "output_sync_event_2lss1tau_incl.root",
                         "syncTree_2lSS1tau_Fake", Analyze_2lss1tau,
                         Control_fake_2lss1tau, debug);

        cout << "2lss1tau charge flip region ... " << endl;
        synctree_2lss1tau_flip =
            makeSyncTree(cdir + "output_sync_event_2lss1tau_incl.root",
                         "syncTree_2lSS1tau_Flip", Analyze_2lss1tau,
                         Control_2los1tau, debug);
    ...
    if (make3l1tau) {
        ...
        synctree_3l1tau_sr = makeSyncTree(
            cdir + "output_sync_event_3l1tau_incl.root", "syncTree_3l1tau_SR",
            Analyze_3l1tau, Signal_3l1tau, debug);

        cout << "3l1tau fake extrapolation region ... " << endl;
        synctree_3l1tau_fake = makeSyncTree(
            cdir + "output_sync_event_3l1tau_incl.root", "syncTree_3l1tau_Fake",
                    ...
                    const TString intreename)
{
    ...
    for (int i = 0; i < nEntries; ++i) {
        ...
        if (anatype != Analyze_NA) {
            ...
            ////////////////////////////////////////
            if (not evt_selector.pass_extra_event_selection(
                    anatype, seltype, &leptons, &taus_tight, &taus_fakeable))
                continue;
        ...
        if (evNtuple.mu_pt->size() > 0) {
            ...
            syncntuple.mu0_jetNDauChargedMVASel =
                evNtuple.mu_jetNDauChargedMVASel->at(0);
            ...
            syncntuple.mu0_segmentCompatibility =
                evNtuple.mu_segmentCompatibility->at(0);
        ...
        if (evNtuple.mu_pt->size() > 1) {
            ...
            syncntuple.mu1_jetNDauChargedMVASel =
                evNtuple.mu_jetNDauChargedMVASel->at(1);
            ...
            syncntuple.mu1_segmentCompatibility =
                evNtuple.mu_segmentCompatibility->at(1);
        ...
        if (evNtuple.ele_pt->size() > 0) {
            ...
            syncntuple.ele0_jetNDauChargedMVASel =
                evNtuple.ele_jetNDauChargedMVASel->at(0);
            ...
            syncntuple.ele0_isChargeConsistent =
                evNtuple.ele_isChargeConsistent->at(0);
            syncntuple.ele0_passesConversionVeto =
                evNtuple.ele_passesConversionVeto->at(0);
        ...
        if (evNtuple.ele_pt->size() > 1) {
            ...
            syncntuple.ele1_jetNDauChargedMVASel =
                evNtuple.ele_jetNDauChargedMVASel->at(1);
            ...
            syncntuple.ele1_isChargeConsistent =
                evNtuple.ele_isChargeConsistent->at(1);
            syncntuple.ele1_passesConversionVeto =
                evNtuple.ele_passesConversionVeto->at(1);
        ...
        if (evNtuple.tau_pt->size() > 0) {
            ...
            syncntuple.tau0_decayModeFindingOldDMs =
                evNtuple.tau_decayModeFindingOldDMs->at(0);
            syncntuple.tau0_decayModeFindingNewDMs =
                evNtuple.tau_decayModeFindingNewDMs->at(0);
            syncntuple.tau0_byCombinedIsolationDeltaBetaCorr3Hits =
                evNtuple.tau_byCombinedIsolationDeltaBetaCorr3Hits->at(0);
            syncntuple.tau0_byLooseCombinedIsolationDeltaBetaCorr3Hits =
                evNtuple.tau_byLooseCombinedIsolationDeltaBetaCorr3Hits->at(0);
            syncntuple.tau0_byMediumCombinedIsolationDeltaBetaCorr3Hits =
                evNtuple.tau_byMediumCombinedIsolationDeltaBetaCorr3Hits->at(0);
            syncntuple.tau0_byTightCombinedIsolationDeltaBetaCorr3Hits =
                evNtuple.tau_byTightCombinedIsolationDeltaBetaCorr3Hits->at(0);
            syncntuple.tau0_byLooseIsolationMVArun2v1DBdR03oldDMwLT =
                evNtuple.tau_byLooseIsolationMVArun2v1DBdR03oldDMwLT->at(0);
            syncntuple.tau0_byMediumIsolationMVArun2v1DBdR03oldDMwLT =
                evNtuple.tau_byMediumIsolationMVArun2v1DBdR03oldDMwLT->at(0);
            syncntuple.tau0_byTightIsolationMVArun2v1DBdR03oldDMwLT =
                evNtuple.tau_byTightIsolationMVArun2v1DBdR03oldDMwLT->at(0);
            syncntuple.tau0_byVTightIsolationMVArun2v1DBdR03oldDMwLT =
                evNtuple.tau_byVTightIsolationMVArun2v1DBdR03oldDMwLT->at(0);
            syncntuple.tau0_againstMuonLoose3 =
                evNtuple.tau_againstMuonLoose3->at(0);
            syncntuple.tau0_againstMuonTight3 =
                evNtuple.tau_againstMuonTight3->at(0);
            syncntuple.tau0_againstElectronVLooseMVA6 =
                evNtuple.tau_againstElectronVLooseMVA6->at(0);
            syncntuple.tau0_againstElectronLooseMVA6 =
                evNtuple.tau_againstElectronLooseMVA6->at(0);
            syncntuple.tau0_againstElectronMediumMVA6 =
                evNtuple.tau_againstElectronMediumMVA6->at(0);
            syncntuple.tau0_againstElectronTightMVA6 =
                evNtuple.tau_againstElectronTightMVA6->at(0);
        }
        if (evNtuple.tau_pt->size() > 1) {
            ...
            syncntuple.tau1_decayModeFindingOldDMs =
                evNtuple.tau_decayModeFindingOldDMs->at(1);
            syncntuple.tau1_decayModeFindingNewDMs =
                evNtuple.tau_decayModeFindingNewDMs->at(1);
            syncntuple.tau1_byCombinedIsolationDeltaBetaCorr3Hits =
                evNtuple.tau_byCombinedIsolationDeltaBetaCorr3Hits->at(1);
            syncntuple.tau1_byLooseCombinedIsolationDeltaBetaCorr3Hits =
                evNtuple.tau_byLooseCombinedIsolationDeltaBetaCorr3Hits->at(1);
            syncntuple.tau1_byMediumCombinedIsolationDeltaBetaCorr3Hits =
                evNtuple.tau_byMediumCombinedIsolationDeltaBetaCorr3Hits->at(1);
            syncntuple.tau1_byTightCombinedIsolationDeltaBetaCorr3Hits =
                evNtuple.tau_byTightCombinedIsolationDeltaBetaCorr3Hits->at(1);
            syncntuple.tau1_byLooseIsolationMVArun2v1DBdR03oldDMwLT =
                evNtuple.tau_byLooseIsolationMVArun2v1DBdR03oldDMwLT->at(1);
            syncntuple.tau1_byMediumIsolationMVArun2v1DBdR03oldDMwLT =
                evNtuple.tau_byMediumIsolationMVArun2v1DBdR03oldDMwLT->at(1);
            syncntuple.tau1_byTightIsolationMVArun2v1DBdR03oldDMwLT =
                evNtuple.tau_byTightIsolationMVArun2v1DBdR03oldDMwLT->at(1);
            syncntuple.tau1_byVTightIsolationMVArun2v1DBdR03oldDMwLT =
                evNtuple.tau_byVTightIsolationMVArun2v1DBdR03oldDMwLT->at(1);
            syncntuple.tau1_againstMuonLoose3 =
                evNtuple.tau_againstMuonLoose3->at(1);
            syncntuple.tau1_againstMuonTight3 =
                evNtuple.tau_againstMuonTight3->at(1);
            syncntuple.tau1_againstElectronVLooseMVA6 =
                evNtuple.tau_againstElectronVLooseMVA6->at(1);
            syncntuple.tau1_againstElectronLooseMVA6 =
                evNtuple.tau_againstElectronLooseMVA6->at(1);
            syncntuple.tau1_againstElectronMediumMVA6 =
                evNtuple.tau_againstElectronMediumMVA6->at(1);
            syncntuple.tau1_againstElectronTightMVA6 =
                evNtuple.tau_againstElectronTightMVA6->at(1);
        }
        ...
        syncntuple.metLD =
            0.00397 * syncntuple.PFMET + 0.00265 * syncntuple.MHT;
        ...
        syncntuple.mindr_lep0_jet =
            mvantuple.compute_min_dr(leptons[0].p4(), jets);
        syncntuple.mindr_tau_jet =
            mvantuple.compute_min_dr(taus->at(0).p4(), jets);
        syncntuple.MT_met_lep0 = mvantuple.compute_mT_lep(
            leptons[0], syncntuple.PFMET, syncntuple.PFMETphi);
        ...
        if (leptons.size() > 1) {
            ...
            syncntuple.mindr_lep1_jet =
                mvantuple.compute_min_dr(leptons[1].p4(), jets);
        ...
        if (leptons.size() > 2) {
            syncntuple.mindr_lep2_jet =
                mvantuple.compute_min_dr(leptons[2].p4(), jets);
            syncntuple.dR_l2tau = leptons[2].p4().DeltaR(taus->at(0).p4());
            syncntuple.MT_met_lep2 = mvantuple.compute_mT_lep(
                leptons[2], syncntuple.PFMET, syncntuple.PFMETphi);
            ;
        }
        ...
        if (seltype == Control_fake_1l2tau or
            seltype == Control_fake_2lss1tau or seltype == Control_fake_3l1tau)
